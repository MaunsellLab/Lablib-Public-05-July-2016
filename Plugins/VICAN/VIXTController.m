...
NSString *VIXTAutosaveKey = @"VIXTAutosave";

@implementation VIXTController
...
- (id)init {
    ...
    if ((self = [super initWithWindowNibName:@"VIXTController"]) != nil) {
 		[self setShouldCascadeWindows:NO];
        [self setWindowFrameAutosaveName:VIXTAutosaveKey];
...
//            hasHorizontalScroller:YES hasVerticalScroller:YES borderType:[scrollView borderType]];
	...
	[[self window] setFrameUsingName:VIXTAutosaveKey];			// Needed when opened a second time
